...
footer / 底部栏 / 状态栏 / 余额 / balance / ¥ / in out / cache hit / ctx / 后台任务 / bg / `fetchBalance` / `totalBalance` / `cumulativeTokens` / 终端标题 / tab 标题 / 窗口标题 / title / OSC 0 / ✳ / ⠂ / ⠋ / 盲文 / 转圈 / spinner / `terminal-title` / `DEEPDIVE_DISABLE_TERMINAL_TITLE`
